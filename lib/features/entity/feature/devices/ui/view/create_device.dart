...
class CreateDeviceWidget extends StatefulWidget {
  const CreateDeviceWidget({super.key});

  @override
  State<CreateDeviceWidget> createState() => _CreateDeviceWidgetState();
}
...
class _CreateDeviceWidgetState extends State<CreateDeviceWidget> {
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(
                  context.translate(key: 'add_new_device_title'),
                  style: context.h4,
                ),
                serialField,
                modelField,
  ...
  void _submit() {
    if (_formKey.currentState?.validate() == true) {
      ...
      DeviceEvents event = CreateNewDeviceEvent(
        token: a.token,
